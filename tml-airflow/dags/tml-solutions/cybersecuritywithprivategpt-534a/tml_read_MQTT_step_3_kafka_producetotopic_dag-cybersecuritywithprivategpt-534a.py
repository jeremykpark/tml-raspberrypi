...
default_args = {
  ...
  'mqtt_broker' : '1c2f90b2b23e44f5b6d7a93a2006eaa5.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
  'mqtt_port' : '8883', # <<<******** Enter MQTT port i.e. 1883, 8883    (for HiveMQ cluster)
  'mqtt_subscribe_topic' : 'tml/cybersophos', # <<<******** enter name of MQTT to subscribe to i.e. tml/iot  
